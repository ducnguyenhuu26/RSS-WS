...
from .core import EvaluatableWorldModel, SymbolicEnvironment

MetadataT = TypeVar("MetadataT")


class TrueTransitionWorldModel(Generic[MetadataT]):
    ...
    def _states_equal(self, state1: MetadataT, state2: MetadataT) -> bool:
